...
public class AntEditorPreferenceConstants {
	...
	/**
	 * A named preference that controls if the Ant editor code assist inserts a proposal automatically if only one proposal is available.
	 * <p>
	 * Value is of type <code>Boolean</code>.
	 * </p>
	 * 
	...
	/**
	 * A named preference that controls if the Ant editor presents code assist proposals for user defined tasks
	 * <p>
	 * Value is of type <code>Boolean</code>.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Value is of type <code>boolean</code>. If <code>false</code> spaces instead of tabs are used when formatting. If <code>true</code> the
	 * formatter inserts a tab character for indenting.
	 * </p>
	 */
	...
	/**
	 * A named preference that specifies if the Ant formatter should wrap elements that are longer than the maximum line length.
	 * <p>
	 * Value is of type <code>Boolean</code>. If <code>true</code> long elements are wrapped when formatting in the editor.
	 * </p>
	 */
	public static final String FORMATTER_WRAP_LONG = "formatter_wrap_long"; //$NON-NLS-1$

	/**
	 * Boolean preference identifier constant which specifies whether the Ant editor should format templates on insert.
	 */
	...
	/**
	 * String preference identifier constant which specifies the severity level for problems related to classpath in the Ant editor
	 */
	public static final String PROBLEM_CLASSPATH = PROBLEM + "_classpath"; //$NON-NLS-1$

	/**
	 * String preference identifier constant which specifies the severity level for problems related to properties in the Ant editor
	 */
	public static final String PROBLEM_PROPERTIES = PROBLEM + "_properties"; //$NON-NLS-1$

	/**
	 * String preference identifier constant which specifies the severity level for problems related to imports in the Ant editor
	 */
	public static final String PROBLEM_IMPORTS = PROBLEM + "_imports"; //$NON-NLS-1$

	/**
	 * String preference identifier constant which specifies the severity level for problems related to tasks in the Ant editor
	 */
	public static final String PROBLEM_TASKS = PROBLEM + "_tasks"; //$NON-NLS-1$

	/**
	 * String preference identifier constant which specifies the severity level for problems related to security exceptions in the Ant editor
	 */
	...
	/**
	 * A named preference that controls if background reconciling is triggered by the user typing in the editor
	 * <p>
	 * Value is of type <code>Boolean</code>.
	 * </p>
	 * 
