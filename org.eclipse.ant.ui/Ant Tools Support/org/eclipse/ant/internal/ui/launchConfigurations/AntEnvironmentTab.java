...
/**
 * An environment tab for Ant launch configurations. Environment variables are only supported when Ant is run in a separate VM, so this tab adds a
 * warning message at the top and disables the widgets if the config isn't set to run in a separate VM.
 */
