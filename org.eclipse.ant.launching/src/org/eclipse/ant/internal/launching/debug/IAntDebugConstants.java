...
public interface IAntDebugConstants {
	...
	/**
	 * Unique identifier for the Ant debug model (value <code>org.eclipse.ant.ui.debug</code>).
	 */
	public static final String ID_ANT_DEBUG_MODEL = "org.eclipse.ant.ui.debug"; //$NON-NLS-1$

	/**
	 * Unique identifier for the Ant line breakpoint markers (value <code>org.eclipse.ant.ui.antLineBreakpointMarker</code>).
	 */
	public static final String ID_ANT_LINE_BREAKPOINT_MARKER = "org.eclipse.ant.ui.antLineBreakpointMarker"; //$NON-NLS-1$

	/**
	 * Unique identifier for the Ant run to line breakpoints (value <code>org.eclipse.ant.ui.runToLineBreakpoint</code>).
	 */
